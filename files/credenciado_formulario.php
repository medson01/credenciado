 <?php 
    ...
    $query = mysqli_query($conn,"SELECT `id`,`nome`,`nome_fantasia`,`cpf_cnpj`, `codigo`, `data_inc`, `telefone`, `celular`, `email`, `endereco`, `numero`, `bairro`, `cep`, `cidade`, `banco`, `operacao`, `agencia` FROM `credenciado` WHERE id = '".$_GET['id']."'") or die("erro ao carregar consulta");
                      ...
                      <div align="center">
                        ...
                        <table width="632" border="0" align="center">
                          <tr>
                            ...
                            <td >Número</td>
                            <td >&nbsp;</td>
                            <td colspan="2"><input  name="numero"  type="text" class="form-matric" id="numero" size="12" maxlength="10" required="required"  <?php if(isset($_GET['id'])){ echo "value='".$numero."'"; }?> /></td>
                            <td width="17">&nbsp;</td>
                            <td colspan="2">Bairro</td>
                            <td colspan="2"><input  class="form-matric" minlength="4" name="bairro" type="text"id="bairro"size="20"maxlength="20" required="required"  <?php if(isset($_GET['id'])){ echo "value='".$bairro."'"; }?> /></td>
                            </tr>
                            <tr>
                              <td colspan="2">&nbsp;</td>
                              <td colspan="7">&nbsp;</td>
                            ...
                            <tr>
                              <td colspan="2">Cep</td>
                              <td colspan="7"><input  class="form-matric" minlength="4" name="cep" id="cep" type="text" size="12"maxlength="10" required="required"  <?php if(isset($_GET['id'])){ echo "value='".$cep."'"; }?> /></td>
                            </tr>
                            <tr>
                            <td colspan="2">&nbsp;</td>
                            <td colspan="7">&nbsp;</td>
                            ...
                            <tr>
                              <td >Cidade</td>
                              <td >&nbsp;</td>
                              <td colspan="2"><input  class="form-matric" minlength="4" name="cidade" type="text"id="cidade"size="12"maxlength="10" required="required"  <?php if(isset($_GET['id'])){ echo "value='".$cidade."'"; }?> /></td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              <td >Telefone</td>
                              <td >&nbsp;</td>
                              <td colspan="2"><input  class="form-matric" minlength="4" name="telefone" type="text"id="telefone"size="12"maxlength="10"  <?php if(isset($_GET['id'])){ echo "value='".$telefone."'"; }?>/></td>
                              <td>&nbsp;</td>
                              <td colspan="2">Celular</td>
                              <td colspan="2"><input  class="form-matric" minlength="4" name="celular" type="text"id="celular"size="20"maxlength="20"  <?php if(isset($_GET['id'])){ echo "value='".$celular."'"; }?> /></td>
                            </tr>
                          <tr>
                            <td colspan="2">&nbsp;</td>
                            <td colspan="7">&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td width="242">&nbsp;&nbsp;<input  class="form-matric" minlength="4" name="conta" type="text"id="conta"size="10"maxlength="11"   <?php if(isset($_GET['id'])){ echo "value='".$conta."'"; }?>/></td>
                            </tr>
                            <tr>
                              <td colspan="2" >&nbsp;</td>
                              <td colspan="7">&nbsp;</td>
