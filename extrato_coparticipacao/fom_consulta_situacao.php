      ...
      <table height="772" id="portal-columns">
        <tbody>
          <tr>
            ...
            <td width="142" height="766" id="portal-column-one"><p align="center" class="style1">
              </p>
              <p>
...
<p>
  <!--  <input name="submit2" type="submit" value="Boleto" class="btn btn-default" style="background:#CCCCCC; font-weight: bold; height: 35px; width:100px;"/> -->
            ...
            <td width="1106" id="portal-column-content">
                  ...
                  <div id="region-content" class="documentContent">
                    ...
                    <div id="content">
                      			...
                      			<div>
   									 ...
   									 <h1 class="documentFirstHeading">Consulta de Situa&ccedil;&atilde;o </h1>
...
<div id="IframePos">
		<iframe id="frame" type="text/html" width="995" height="1000" src="http://www.ipasealsaude.al.gov.br/consulta-de-situacao" frameborder="0"  allowfullscreen scrolling="no" marginheight="100px"></iframe>
...
<br />
<br /> -->
<center> <span class="style6"><a onclick="history.go(-1)" >&lt;&lt;&lt; Voltar </a></span> </center></div>
       <!--       </div>
